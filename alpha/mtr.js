NAME_OF_HKO = {
    WFIREY:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=https://www.hko.gov.hk/tc/textonly/img/warn/images/firey.gif align=bottom width=\"40px\" height=\"40px\"></a>",
    WFIRER:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=https://www.hko.gov.hk/tc/textonly/img/warn/images/firer.gif align=bottom width=\"40px\" height=\"40px\"></a>",
    WRAINB:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=https://www.hko.gov.hk/tc/textonly/img/warn/images/rainb.gif align=bottom width=\"40px\" height=\"40px\"></a>",
    WRAINR:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=https://www.hko.gov.hk/tc/textonly/img/warn/images/rainr.gif align=bottom width=\"40px\" height=\"40px\"></a>",
    WRAINA:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=https://www.hko.gov.hk/tc/textonly/img/warn/images/raina.gif align=bottom width=\"40px\" height=\"40px\"></a>",
    八號西南烈風或暴風信號:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=wws/t8sw.png align=bottom width=\"40px\" height=\"40px\"></a>",
    八號東南烈風或暴風信號:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=wws/t8se.png align=bottom width=\"40px\" height=\"40px\"></a>",
    八號西北烈風或暴風信號:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=wws/t8nw.png align=bottom width=\"40px\" height=\"40px\"></a>",
    八號東北烈風或暴風信號:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=wws/t8ne.png align=bottom width=\"40px\" height=\"40px\"></a>",
    三號強風信號:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=wws/t3.png align=bottom width=\"40px\" height=\"40px\"></a>",
    一號戒備信號:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=wws/t1.png align=bottom width=\"40px\" height=\"40px\"></a>",
    強烈季候風信號:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=https://www.hko.gov.hk/tc/wservice/warning/images/smsimg.png align=bottom width=\"40px\" height=\"40px\"></a>",
    寒冷天氣警告:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=https://www.hko.gov.hk/tc/wservice/warning/images/warncold.gif align=bottom width=\"40px\" height=\"40px\"></a>",
    雷暴警告:"<a href=https://www.hko.gov.hk/tc/detail.htm><img src=https://www.hko.gov.hk/tc/textonly/img/warn/images/ts.gif align=bottom width=\"40px\" height=\"40px\"></a>",
    取消所有熱帶氣旋警告信號:"",
    NA:""
}
...
async function getInfo(){
    ...
    const allbox=" "+NAME_OF_HKO[box1]+NAME_OF_HKO[box5]+NAME_OF_HKO[box6]+NAME_OF_HKO[box2]+NAME_OF_HKO[box3]+NAME_OF_HKO[box4];
        if(d.getMinutes()<10){
            ...
            document.getElementById('bg1').innerHTML=d.getHours()+":"+d.getMinutes()+" "+temp+allbox;
            document.getElementById('STA').innerHTML="輕鐵班次 - 良景站 ";
        }
...
async function getENGInfo(){
    ...
    const allbox=" "+NAME_OF_HKO[box1]+NAME_OF_HKO[box5]+NAME_OF_HKO[box6]+NAME_OF_HKO[box2]+NAME_OF_HKO[box3]+NAME_OF_HKO[box4];
        if(d.getMinutes()<10){
            document.getElementById('STA').innerHTML="Light Rail - Leung King Station";
        } else {
            document.getElementById('STA').innerHTML="Light Rail - Leung King Station";
        }
...
async function getKMBinfo(){
     ...
     */
    if(d.getMinutes()<10){
    document.getElementById('STA').innerHTML="巴士班次 - 良景站";
    } else {
        document.getElementById('STA').innerHTML="巴士班次 - 良景站";
    }
    if(TL==0){
...
MEF: "Mei Foo"
    ...
    if(TL2==0){
        document.getElementById('message4').innerHTML=`<b>屯門站</b> - <b>${STA_NAMETC[TML.dest]}</b>`+" <b>"+TML.plat+"</b>號月台 <br>正在離開... | <b>"+TL3.toString()+"</b> 分鐘 | <b>"+TL4.toString()+"</b> 分鐘"
    } else {
        document.getElementById('message4').innerHTML=`<b>屯門站</b> - <b>${STA_NAMETC[TML.dest]}</b>`+" <b>"+TML.plat+"</b>號月台 <br>時間： <b>"+TL2.toString()+"</b> 分鐘 | <b>"+TL3.toString()+"</b> 分鐘 | <b>"+TL4.toString()+"</b> 分鐘"
    }
}
